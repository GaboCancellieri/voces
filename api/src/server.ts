...
class Server {
    ...
    constructor() {
        ...
        mongoose.connect(`mongodb://${process.env.MONGO_HOST}:${process.env.MONGO_PORT}/voces`, { useNewUrlParser: true, useUnifiedTopology: true }); 
        this.config();
        this.routes();
    }
      ...
      if(process.env.NODE_ENV === 'production') {
        https.createServer({
          ...
          cert: fs.readFileSync('cadenacampoargentino.com.pem')
            ...
            console.log(`My https server listening on: ${this.host}:${this.app.get('port')}...`);
        });
